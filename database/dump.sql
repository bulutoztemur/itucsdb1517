...
ALTER TABLE IF EXISTS ONLY public.coach DROP CONSTRAINT IF EXISTS coach_pkey CASCADE;
ALTER TABLE IF EXISTS public.usertable ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.userrole ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.userinformation ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.transfer ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.team ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.statistic ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.season ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public."position" ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.player ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.match ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.hand ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.gender ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.court ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.country ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
ALTER TABLE IF EXISTS public.coach ALTER COLUMN IF EXISTS objectid DROP DEFAULT CASCADE;
