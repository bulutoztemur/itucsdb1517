...
ALTER TABLE IF EXISTS ONLY public.usertable DROP CONSTRAINT usertable_userroleid_fkey;
ALTER TABLE IF EXISTS ONLY public.usertable DROP CONSTRAINT usertable_userinformationid_fkey;
ALTER TABLE IF EXISTS ONLY public.userinformation DROP CONSTRAINT userinformation_favoriteteamid_fkey;
ALTER TABLE IF EXISTS ONLY public.transfer DROP CONSTRAINT transfer_seasonid_fkey;
ALTER TABLE IF EXISTS ONLY public.transfer DROP CONSTRAINT transfer_playerid_fkey;
ALTER TABLE IF EXISTS ONLY public.transfer DROP CONSTRAINT transfer_oldteamid_fkey;
ALTER TABLE IF EXISTS ONLY public.transfer DROP CONSTRAINT transfer_newteamid_fkey;
ALTER TABLE IF EXISTS ONLY public.team DROP CONSTRAINT team_courtid_fkey;
ALTER TABLE IF EXISTS ONLY public.team DROP CONSTRAINT team_countryid_fkey;
ALTER TABLE IF EXISTS ONLY public.statistic DROP CONSTRAINT statistic_seasonid_fkey;
ALTER TABLE IF EXISTS ONLY public.statistic DROP CONSTRAINT statistic_playerid_fkey;
ALTER TABLE IF EXISTS ONLY public.player DROP CONSTRAINT player_teamid_fkey;
ALTER TABLE IF EXISTS ONLY public.player DROP CONSTRAINT player_positionid_fkey;
ALTER TABLE IF EXISTS ONLY public.player DROP CONSTRAINT player_handid_fkey;
ALTER TABLE IF EXISTS ONLY public.player DROP CONSTRAINT player_genderid_fkey;
ALTER TABLE IF EXISTS ONLY public.player DROP CONSTRAINT player_countryid_fkey;
ALTER TABLE IF EXISTS ONLY public.match DROP CONSTRAINT match_hometeamid_fkey;
ALTER TABLE IF EXISTS ONLY public.match DROP CONSTRAINT match_courtid_fkey;
ALTER TABLE IF EXISTS ONLY public.match DROP CONSTRAINT match_awayteamid_fkey;
ALTER TABLE IF EXISTS ONLY public.coach DROP CONSTRAINT coach_teamid_fkey;
ALTER TABLE IF EXISTS ONLY public.coach DROP CONSTRAINT coach_genderid_fkey;
ALTER TABLE IF EXISTS ONLY public.coach DROP CONSTRAINT coach_countryid_fkey;
ALTER TABLE IF EXISTS ONLY public.usertable DROP CONSTRAINT usertable_pkey;
ALTER TABLE IF EXISTS ONLY public.userrole DROP CONSTRAINT userrole_pkey;
ALTER TABLE IF EXISTS ONLY public.userinformation DROP CONSTRAINT userinformation_pkey;
ALTER TABLE IF EXISTS ONLY public.transfer DROP CONSTRAINT transfer_pkey;
ALTER TABLE IF EXISTS ONLY public.team DROP CONSTRAINT team_pkey;
ALTER TABLE IF EXISTS ONLY public.statistic DROP CONSTRAINT statistic_pkey;
ALTER TABLE IF EXISTS ONLY public.season DROP CONSTRAINT season_pkey;
ALTER TABLE IF EXISTS ONLY public."position" DROP CONSTRAINT position_pkey;
ALTER TABLE IF EXISTS ONLY public.player DROP CONSTRAINT player_pkey;
ALTER TABLE IF EXISTS ONLY public.match DROP CONSTRAINT match_pkey;
ALTER TABLE IF EXISTS ONLY public.hand DROP CONSTRAINT hand_pkey;
ALTER TABLE IF EXISTS ONLY public.gender DROP CONSTRAINT gender_pkey;
ALTER TABLE IF EXISTS ONLY public.court DROP CONSTRAINT court_pkey;
ALTER TABLE IF EXISTS ONLY public.country DROP CONSTRAINT country_pkey;
ALTER TABLE IF EXISTS ONLY public.coach DROP CONSTRAINT coach_pkey;
